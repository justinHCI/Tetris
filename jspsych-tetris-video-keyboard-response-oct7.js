...
////	  {document.getElementById("audio");
 ...
 var context = jsPsych.pluginAPI.audioContext();
	...
	t = Math.floor((Math.random() * 10000) + 5000);
	$('#jspsych-content').append(trial.prompt).delay(t).queue(function (next) {
	...
	$('#jspsych-content').append("<div>Your Partner: Leigh </div><div id=message>Message: </div>" );
...
//					console.log(audiofilename)
					...
					var speakdelay = (Math.random() * 500) +1700;
//					setTimeout(function(){audiofile.play();},t);
				...
				if(e.code === 'Enter' && document.getElementById("spoken")){
