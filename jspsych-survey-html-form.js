...
jsPsych.plugins['survey-html-form'] = (function() {
   ...
   */
	...
	//JUSTIN EDIT - textareas lose their name attributes and are not serialized. Fill the names array with a list of desired names for textareas and they'll get them back
  var serializeArray = function (form) {
    // Setup our serialized data
    var serialized = [];
	var namelesscounter = 0;
	var names = ["lowTime", "lowHow", "highTime", "highHow"];
    ...
    for (var i = 0; i < form.elements.length; i++) {
      var field = form.elements[i];
		...
		if (!field.name && field.type=="textarea") {
			field.name = names[namelesscounter];
			namelesscounter += 1;
		}

      // Don't serialize fields without a name, submits, buttons, file and reset inputs, and disabled fields
      if ((!field.name && field.type!="textarea") || field.disabled || field.type === 'file' || field.type === 'reset' || field.type === 'submit' || field.type === 'button') continue;
